...
{
    public partial class Prioridad : MetroForm
    {
        public Prioridad()
        {
            InitializeComponent();
        ...
        {
            String busqueda = "select Documento, Nombres, Apellidos, Edad, Direccion, Sexo, Peso, Estatura, Fumador, añosfumador as 'Años fumando', Dieta, Prioridad from pacientes WHERE (Estado ='Pendiente') ORDER BY Prioridad DESC ; ";
            ...
            lb_prioridafumador.Text = "Paciente fumador de mayor prioridad: " + basededatos.Mayorprioridadfumador();
